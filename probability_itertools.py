...
def main():
    # Input
    N = int(input("Enter the number of elements (N): "))  # Number of elements in the list
    letters = input("Enter the letters separated by spaces: ").split()  # List of letters
    K = int(input("Enter the number of indices to select (K): "))  # Number of indices to be selected
